    ...
    <AppShell>
      ...
      <div className="mb-12 relative z-10">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-700 font-poppins max-w-2xl mx-auto">
            Enter a hash, upload a PDF, or provide a URL to verify your
      ...
      {(data || fileResult) && (
        <div className="mb-8 rounded-3xl bg-white/60 backdrop-blur-xl border-2 border-sky-100 p-8 transition-all duration-500 hover:shadow-2xl hover:shadow-sky-200/30 relative z-10">
          {statusInfo && (
            <div
              className={`mb-6 rounded-2xl p-6 border-2 flex items-start gap-4 ${
                statusInfo.color === "emerald"
                  ? "bg-linear-to-br from-emerald-50 to-emerald-50/40 border-emerald-200/60"
                  : statusInfo.color === "red"
                  ? "bg-linear-to-br from-red-50 to-red-50/40 border-red-200/60"
                  : "bg-linear-to-br from-amber-50 to-amber-50/40 border-amber-200/60"
              }`}
            >
              <div
              ...
              <div className="flex-1">
                <h3
                  className={`text-xl font-bold font-cairo uppercase ${
                    statusInfo.color === "emerald"
                      ? "text-emerald-900"
                      : statusInfo.color === "red"
                      ? "text-red-900"
            ...
            <div className="mb-6 grid gap-4 sm:grid-cols-2">
              {data.certificate.studentName && (
                <div className="rounded-2xl border-2 border-sky-100 bg-white/70 backdrop-blur-sm p-5 transition-all hover:border-[#28aeec] hover:shadow-lg">
                  <div className="text-xs font-bold uppercase tracking-wide text-gray-600 mb-2 font-cairo">
                    Student Name
                  </div>
          ...
          <div className="rounded-2xl border-2 border-sky-100 bg-white/70 backdrop-blur-sm p-6">
            ...
            <code className="block rounded-xl border-2 border-sky-100 bg-linear-to-br from-sky-50/50 to-white p-4 font-mono text-sm break-all text-gray-900">
              {hash || data?.hash || "N/A"}
            </code>
            {data?.issuanceTimestamp && (
              <div className="mt-4 text-sm text-gray-700 font-poppins">
                <strong className="font-semibold">Issued On:</strong>{" "}
            ...
            {data?.certificate?.txHash && (
              <div className="mt-4 flex items-center gap-2 flex-wrap">
                ...
                <span className="text-sm font-mono text-gray-600">
                  ({data.certificate.txHash.slice(0, 10)}...
      ...
      <div className="space-y-8 relative z-10">
        <div className="text-center">
          ...
          <p className="mt-3 text-lg text-gray-700 font-poppins">
            Select one of the methods below to verify your certificate
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-center lg:items-stretch">
          ...
          <div className="flex items-center justify-center w-full lg:w-auto">
            <div className="flex lg:flex-col items-center gap-4 w-full lg:w-auto py-4 lg:py-0 lg:px-4">
              <div className="flex-1 lg:flex-none lg:w-px lg:h-24 h-px bg-linear-to-r lg:bg-linear-to-b from-transparent via-sky-300 to-sky-300"></div>
              <div className="px-5 py-2 rounded-full bg-linear-to-r from-[#28aeec] to-sky-400 border-2 border-white shadow-lg shrink-0">
                <span className="text-sm font-bold text-white font-cairo">
                  OR
                </span>
              </div>
              <div className="flex-1 lg:flex-none lg:w-px lg:h-24 h-px bg-linear-to-l lg:bg-linear-to-t from-transparent via-sky-300 to-sky-300"></div>
            </div>
          </div>
          ...
          <div className="flex-1 rounded-3xl bg-white/60 backdrop-blur-xl border-2 border-sky-100 p-8 transition-all duration-500 hover:shadow-2xl hover:shadow-sky-200/30 hover:border-[#28aeec]">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-base text-gray-700 mt-1 font-poppins">
                  Upload your certificate file to verify
                </p>
              </div>
            </div>
      ...
      {(data?.error || fileResult?.error) && (
        <div className="mt-8 rounded-2xl bg-linear-to-br from-red-50 to-red-50/40 p-6 border-2 border-red-200/60 flex items-start gap-4 relative z-10">
